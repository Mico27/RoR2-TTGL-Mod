...
namespace TTGL_Survivor.Modules.Survivors
{
    public class Gurren: BaseSurvivor
    {
        ...
        protected override void SetupCharacterBody(string bodyName, GameObject newPrefab, Transform modelBaseTransform)
        {
            ...
            bodyComponent.portraitIcon = Modules.TTGLAssets.LoadAsset<Texture>("GurrenIcon");
        ...
        private void CreateSkills()
        {
            ...
            skillLocator.passiveSkill.icon = Modules.TTGLAssets.LoadAsset<Sprite>("KaminaSpiritIcon");
            ...
            tripleSlashSkillDef.icon = Modules.TTGLAssets.LoadAsset<Sprite>("TripleSlashIcon");
            ...
            throwinShadesSkillDef.icon = Modules.TTGLAssets.LoadAsset<Sprite>("GurrenDrillBlasterIcon");
            ...
            rollSkillDef.icon = Modules.TTGLAssets.LoadAsset<Sprite>("RollIcon");
            ...
            rockThrowSkillDef.icon = Modules.TTGLAssets.LoadAsset<Sprite>("BoulderThrowIcon");
