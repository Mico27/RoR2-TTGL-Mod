...
namespace TTGL_Survivor.Modules
{
    internal static class Unlockables
    {
        ...
        public static UnlockableDef AddUnlockable<TUnlockable>(bool serverTracked) where TUnlockable : BaseAchievement, IModdedUnlockableDataProvider, new()
        {
            ...
            TTGL_SurvivorPlugin.unlockableDefs.Add(unlockableDef);
        ...
        public static ILCursor CallDel_<TDelegate>(this ILCursor cursor, TDelegate target) where TDelegate : Delegate => cursor.CallDel_(target, out _);
        ...
        private static void Init_Il(ILContext il) => new ILCursor(il)
            ...
            .CallDel_(Helpers.AppendDel(TTGL_SurvivorPlugin.unlockableDefs));
