...
{
    public static class TTGLAssets
    {
        ...
        internal static void PopulateAssets()
        {
            ...
            var test = System.IO.Path.Combine(ResourcesPath, "catalog_2024.09.01.16.12.04.json");
            ...
            */
            soundBankId = SoundAPI.SoundBanks.Add(System.IO.Path.Combine(ResourcesPath, "TTGLSoundbank.sound"));
            ...
            yokoRifleHitSmallEffect = TTGLAssets.LoadEffect("YokoRifleHitSmallEffect", 1.0f);
            yokoRifleMuzzleBigEffect = TTGLAssets.LoadEffect("YokoRifleMuzzleBigEffect", 1.0f);
            yokoRifleMuzzleSmallEffect = TTGLAssets.LoadEffect("YokoRifleMuzzleSmallEffect", 1.0f);
            yokoRifleExplosiveRoundExplosion = TTGLAssets.LoadEffect("YokoRifleExplosiveRoundExplosion", 1.0f);
            gurrenBrokenBoulderEffect = TTGLAssets.LoadEffect("BigBoulderBrokenPrefab", 5.0f);
            specialExplosion = TTGLAssets.LoadEffect("SpecialExplosion", 5.0f);
            drillPopEffect = TTGLAssets.LoadEffect("DrillPopEffect", 2.0f, true);
            earthMoundEffect = TTGLAssets.LoadEffect("EarthMoundEffect", 2.0f);
        }
        ...
        {
            GameObject newEffect = Modules.TTGLAssets.LoadAsset<GameObject>(resourceName);
