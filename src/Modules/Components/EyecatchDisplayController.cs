...
{
    public class EyecatchDisplayController : MonoBehaviour
    {
        ...
        public void OnEnable()
        {
            if (Config.eyecatchEnabled)
            {
                ...
                if (isAuthority)
                {
                    ...
                    {
                        case 0:
                            this.PlayAnimation("Base Layer", "TTGLEyeCatch1");
                            break;
                        case 1:
                            this.PlayAnimation("Base Layer", "TTGLEyeCatch2");
                            break;
                        default:
                            this.PlayAnimation("Base Layer", "TTGLEyeCatch3");
                            break;
                    }
                }
            }
