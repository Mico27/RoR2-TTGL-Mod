...
{
    public class GurrenLagannHookPunch : GurrenLagannBaseCombo
    {
        public const float c_DamageCoefficient = 1.8f;

        protected override void PlayAttackAnimation()
        {
            base.PlayCrossfade("FullBody, Override", "GurrenLagannHookPunch", this.playbackRateString, this.duration, 0.05f);
        }
