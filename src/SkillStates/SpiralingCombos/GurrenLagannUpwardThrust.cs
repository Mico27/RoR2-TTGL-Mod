...
{
    public class GurrenLagannUpwardThrust : GurrenLagannBaseCombo
    {
        public const float c_DamageCoefficient = 2.1f;

        protected override void PlayAttackAnimation()
        {
            base.PlayCrossfade("FullBody, Override", "GurrenLagannUpwardThrust", this.playbackRateString, this.duration, 0.05f);
        }
