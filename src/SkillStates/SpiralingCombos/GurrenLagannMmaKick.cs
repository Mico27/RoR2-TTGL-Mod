...
{
    public class GurrenLagannMmaKick : GurrenLagannBaseCombo
    {
        public const float c_DamageCoefficient = 2.7f;
        public const float procCoefficient = 0.6f;

        protected override void PlayAttackAnimation()
        {
            base.PlayCrossfade("FullBody, Override", "GurrenLagannMmaKick", this.playbackRateString, this.duration, 0.05f);
        }
